// ATTENTION: Replace all occurences of "MiniCpp" by the compiler name! 

// MiniCpp.cs                                                        HDO, 2006-08-28
// -----
// Main program for compiler generated from MiniCpp.atg with Coco-2.
//=====================================|========================================
...
public class MiniCpp {
  ...
  //-----------------------------------|----------------------------------------
    ...
    Utils.InstallModule("MiniCppLex",  new Utils.ModuleMethodDelegate(MiniCppLex.MiniCppLexMethod));
    Utils.InstallModule("MiniCppSem",  new Utils.ModuleMethodDelegate(MiniCppSem.MiniCppSemMethod));
    Utils.InstallModule("MiniCppSyn",  new Utils.ModuleMethodDelegate(MiniCppSyn.MiniCppSynMethod));
