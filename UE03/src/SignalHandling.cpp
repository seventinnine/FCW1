...
void signalHandler(int sig) { /*see catch (…) in C++*/
  switch (sig) {
    case SIGABRT: printMessageAndExit(SIGABRT, "SIGABRT");
    case SIGFPE:  printMessageAndExit(SIGFPE,  "SIGFPE");
    case SIGILL:  printMessageAndExit(SIGILL,  "SIGILL");
    case SIGINT:  printMessageAndExit(SIGINT,  "SIGINT");
    case SIGSEGV: printMessageAndExit(SIGSEGV, "SIGSEGV");
    case SIGTERM: printMessageAndExit(SIGTERM, "SIGTERM");
